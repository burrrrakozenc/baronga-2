...
import styles from '../../product-card/product-card.style';
import { AiOutlineShoppingCart } from 'react-icons/ai';
import { IoIosAdd, IoIosRemove, IoLogoGameControllerB } from 'react-icons/io';
import styles2 from "./secondary.style";
...
const CategoryBlock: React.FC<PropsType> = (product) => {
				...
				>
					...
					>
						{quantity > 0 ? (
							...
							// 	/>
							// </svg>
							<AiOutlineShoppingCart style={{ color: 'black', fontSize: '20px' }} />
						)}
					</Button>
